...
const HeaderLogo = () => {
  ...
  return (
    ...
    <div className="flex items-center px-1 md:px-2 justify-begin ">
      <Link href="/">
      ...
      <Link href="/">
        ...
        <div className=" text-2xl font-bold italic text-headMenuText items-center px-4 justify-begin">DBogdan</div>
      </Link>
      {/* ========================================================================== */}
    </div>
  )
