...
export default async function Home() {
  ...
  return (
    ...
    <main className="container mx-auto py-4 ">
      {/* <HomeSlaider /> */}
      <HomeSlaider1 />
      <section className="flex flex-col py-14 space-y-12 pb-4">
        <h1 className="text-4xl font-bold text-headMenuText text-center">Наші вироби - стандартні і художні</h1>
        {/* <h1 className="text-4xl font-bold text-headMenuText text-center">Наші вироби</h1> */}
        {/* <h1 className="text-4xl font-bold text-headMenuText text-center">стандартні і художні</h1> */}
